...
export const metadata: Metadata = {
  title: "Devenir Partenaire - Baraa",
  description: "Rejoignez le réseau de partenaires Baraa et partagez vos livres avec des millions d'étudiants",
}
        ...
        <section className="bg-gradient-to-r from-primary to-primary/80 text-white py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4 md:px-8">
            ...
            <p className="text-white/90 text-base md:text-lg max-w-2xl text-pretty">
              ...
              la plateforme Baraa de confiance
            </p>
          </div>
        </section>
